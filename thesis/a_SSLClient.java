...
public class SSLClient {
	 ...
	 * 
	 * @param truststore
	 *            Stream corresponding to the .bks type store of trusted
	 *            certificates
	 * @param clientstore
	 *            Stream corresponding to the .bks type store containing this
	 *            client's certificate
	 */
	public SSLClient(InputStream truststore, InputStream clientstore) {
		try {

			ThesisLog.l("Setting up SSL capable HttpClient. Starting timer");
			...
			ThesisLog.l("Finished. Total time was: " + time + " milliseconds");
